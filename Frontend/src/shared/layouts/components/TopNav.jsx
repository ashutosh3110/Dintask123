                        ...
                        <DropdownMenuTrigger asChild>
                            <Button variant="ghost" className="p-0 hover:bg-transparent flex items-center gap-2">
                                ...
                                <Avatar className="h-9 w-9 border-2 border-primary-100 dark:border-primary-900">
                                    <AvatarImage src={user?.profileImage ? (user.profileImage.startsWith('http') ? user.profileImage : `https://dintask123.onrender.com/${user.profileImage}`) : `https://api.dicebear.com/7.x/initials/svg?seed=${user?.name}`} />
