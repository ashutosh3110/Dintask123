...
const ManagerChat = () => {
    ...
    // Get unique conversation partners (employees who sent/received messages)
    const chatPartners = useMemo(() => {
        ...
        // Combine team members and existing chat partners
        ...
        <div className="flex h-[calc(100vh-120px)] bg-white dark:bg-slate-900 rounded-3xl shadow-xl overflow-hidden border border-slate-100 dark:border-slate-800">
            ...
            <div className={cn(
                ...
                <div className="p-6 border-b border-slate-50 dark:border-slate-800">
                    <h1 className="text-xl font-black text-slate-900 dark:text-white mb-4">Messages</h1>
            ...
            <div className={cn(
                ...
                {activeChatId ? (
                        ...
                        <div className="flex-1 overflow-y-auto p-6" ref={scrollRef}>
                            <div className="space-y-6">
                                <div className="flex justify-center">
                                    <span className="px-3 py-1 bg-slate-100 dark:bg-slate-800 rounded-full text-[10px] font-black uppercase tracking-widest text-slate-400 shadow-sm ring-1 ring-slate-200 dark:ring-slate-700">
                                        Today
                                    </span>
                                </div>
                            ...
                            >
                                <div className="flex-1 relative group">
                                    <Input
                                        ...
                                        placeholder="Type your security response..."
                    ...
                    <div className="text-center space-y-4 max-w-sm px-10">
                        ...
                        <h2 className="text-2xl font-black text-slate-900 dark:text-white tracking-tight">Select a Secure Channel</h2>
                        <p className="text-sm text-slate-400 font-medium leading-relaxed">
                            Pick a team member from the left to start a high-priority conversation. All messages are encrypted.
                        </p>
                    </div>
                )}
            </div>
